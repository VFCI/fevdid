...
Plotting all of the forecast variance decompositions is equally straightforward (above the code is used to compare two separate fevds).
```{r exanmple_td_fevd, message = F}
...
There is also a generic plot function for all of the frequency domain fevds.
```{r exanmple_fd_fevd, message = F}
